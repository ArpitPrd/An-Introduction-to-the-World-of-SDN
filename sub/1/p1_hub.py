...
class HubController(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        actions = [parser.OFPActionOutput(of_protocol.OFPP_CONTROLLER,
                                          of_protocol.OFPCML_NO_BUFFER)]
    ...
    def add_flow(self, datapath, priority, match, actions):
        of_protocol = datapath.ofproto
        parser = datapath.ofproto_parser
        inst = [parser.OFPInstructionActions(of_protocol.OFPIT_APPLY_ACTIONS, actions)]
    ...
    def _packet_in_handler(self, ev):
        ...
        out = parser.OFPPacketOut(datapath=datapath,
                                  ...
                                  in_port=in_port,
                                  actions=actions,
                                  data=msg.data if msg.buffer_id == of_protocol.OFP_NO_BUFFER else None)
